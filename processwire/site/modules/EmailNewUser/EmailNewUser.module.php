    ...
    protected function populatePassword(HookEvent $event) {
        ...
        if($process instanceof WirePageEditor) {
            ...
            if($userpage->is(Page::statusUnpublished)) {
                ...
                $minLength = $inputfield->minlength > 22 ? $inputfield->minlength : 22;
                ...
                $inputfield->required = false;  // Added 
                $inputfield->removeAttr('autocomplete', 'new-password'); // ProcessProfile and ProcessUser
                $inputfield->notes = 'NOTE: THe password will be automatically generated and provided (WHEN FEATURE HAS BEEN RELEASED).  Do not add a password.';
