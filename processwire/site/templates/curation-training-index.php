...
//      }
    ...
    $render_recommended_training_docs .= "<div class='timeline-item'>
...
if($relate_curation_docs){
  foreach($relate_curation_docs as $key => $value){
    ...
    $render_curation_docs .= "<div class='col-sm-12 mb-3 pb-3 border-bottom-1'>
                        <div class=''>
                          <h4 class='m-0 h5'><a href='{$value->httpUrl}' class='btn btn-primary text-white float-right ml-4'>View<i class='fas fa-arrow-right'></i></a><a href='{$value->httpUrl}' class='{$css_archived}'>{$value->title}</a></h4>
